...
leverage          = dltt / at        (Control)
ln_at             = log(at)          (Control: firm size)
cash_flow         = (ibc + dp) / at  (Control)
age               = fyear - first year in data (Control)
"""
...
numeric_cols = ["at", "ib", "ibc", "capx", "dp", "dltt",
                "sale", "emp", "che", "ppent", "ebit", "ebitda"]
...
core_vars = ["roa", "capital_intensity", "cash_holdings",
